...
description: "Referencia de comandos de terminal para Ubuntu, Debian y Fedora/Red Hat. Navega archivos, gestiona paquetes y administra usuarios desde la línea de comandos."
---
